...
//
// * https://github.com/ubilabs/geocomplete2/
...
(function($, window, document, undefined){
  ...
  function geocomplete2(input, options) {
    ...
    this._name = 'geocomplete2';

    this.init();
  }

  // Initialize all parts of the plugin.
  $.extend(geocomplete2.prototype, {
    init: function(){
      this.initMap();
      this.initMarker();
      this.initGeocoder();
  ...
  $.fn.geocomplete2 = function(options) {

    var attribute = 'plugin_geocomplete2';

    // If you call `.geocomplete2()` with a string as the first parameter
    // it returns the corresponding property or calls the method with the
    // following arguments.
    if (typeof options == "string"){

      var instance = $(this).data(attribute) || $(this).geocomplete2().data(attribute),
      ...
      return this.each(function() {
        ...
        if (!instance) {
          instance = new geocomplete2( this, options );
